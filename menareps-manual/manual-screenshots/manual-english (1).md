...
![The full app sidebar showing all navigation sections and menu items](../../.gitbook/assets/sidebar-navigation.png)
...
![Selecting a physician for a new medical visit — the system shows the physician list and requests GPS confirmation](../../.gitbook/assets/visit-physician-select.png)
...
![Product Detailing tab — record which products were discussed and how the physician responded](../../.gitbook/assets/visit-product-detailing.png)

6. Switch to the **Samples** tab to record any samples distributed during the visit.

![Samples tab — record sample quantities given to the physician during the visit](../../.gitbook/assets/visit-samples.png)

7. Complete the **Outcomes** tab with overall visit notes and next steps.

![Outcomes tab — record overall visit notes, physician reaction, and agreed next actions](../../.gitbook/assets/visit-outcomes.png)
...
![Selecting a pharmacy for a new sales visit — GPS location is confirmed at check-in](../../.gitbook/assets/visit-pharmacy-select.png)

4. The visit form has **4 tabs**:
   * **Order Items** — Add products and quantities for the order placed during this visit.

![Order Items tab — add products and quantities to the order placed during the pharmacy visit](../../.gitbook/assets/visit-order-items.png)

* **Apply Offers** — View and apply any active promotional offers to the order.

![Apply Offers tab — select active promotions to apply to the order, with automatic discount or bonus quantity calculation](../../.gitbook/assets/visit-apply-offers.png)

* **Payment** — Record payment collected, payment method, and outstanding balance.

![Payment tab — record payment collected during the visit and update the pharmacy's outstanding balance](../../.gitbook/assets/visit-payment.png)
...
![Visit completion screen — summary of all visit data before final submission](../../.gitbook/assets/visit-complete.png)
...
* Notifies your manager of any escalated missed visits. Cancelled and replanned visits are highlighted in the planner for easy identification.
...
![Orders page — showing all orders with status badges, values, and quick-action buttons](../../.gitbook/assets/orders.png)
...
![Sample Analytics overview — showing total allocations, distribution metrics, and utilization rate](../../.gitbook/assets/sample-analytics-overview.png)
...
![Sample Analytics inventory tab — showing available stock, reserved quantities, and inventory by product chart](../../.gitbook/assets/sample-analytics-inventory.png)
...
![Supervisor Visit Hub — listing all accompanied field visits logged by supervisors](../../.gitbook/assets/supervisor-visit-hub.png)
...
![Create Supervisor Visit dialog — select the rep, customer, and evaluation criteria for the accompanied visit](../../.gitbook/assets/supervisor-create-visit.png)
...
![Supervisor Reports (Medical tab) — showing plan execution rate, accompanied visits, area coverage, and task completion for the medical team](../../.gitbook/assets/supervisor-reports-medical.png)
...
![Reports Hub — showing summary KPIs, visit status breakdown, and export buttons for visits, orders, and payments](../../.gitbook/assets/reports-hub.png)
...
![Performance Analytics dashboard — comparing rep performance against targets with trend indicators](../../.gitbook/assets/performance-analytics.png)
...
![Medical Visit Quality — physician reaction breakdown by pie chart showing positive, neutral, and negative reactions](../../.gitbook/assets/analytics-physician-reaction.png)

The monthly trends chart shows visit quality scores over time, making it easy to spot improvement or decline.

![Medical Visit Quality — monthly trend chart showing visit quality score evolution over time](../../.gitbook/assets/analytics-monthly-trends.png)

#### Intent Funnel Tab

Switch to the **Intent Funnel** tab to see a breakdown of physician **prescription intent** across your territory:

* A horizontal bar chart shows how many physicians fall into each intent level: _Very Likely → Likely → Neutral → Unlikely → Very Unlikely_
...
* A horizontal bar chart shows how many pharmacy accounts fall into each intent level: _Will Order → Considering → Needs Info → Not Interested_
...
![Product Dashboard overview — showing sales performance KPIs and product-level revenue breakdown](../../.gitbook/assets/product-dashboard-overview.png)

Switch to the **Brand Performance** tab to compare brands side by side with revenue, volume, and target achievement metrics.

![Product Dashboard brand performance — comparing brand-level sales, targets, and achievement percentages](../../.gitbook/assets/product-dashboard-brand.png)
...
![AI Reports Hub — listing all available AI report types including Sales Performance, Territory Analysis, Coaching Summary, and more](../../.gitbook/assets/ai-reports-list.png)
...
![AI Reports Hub — Ask a Question tab, where you can type a natural language query about your data](../../.gitbook/assets/ai-reports-ask.png)
...
![Resource Center — showing engagement metrics and the document library organized by product and category](../../.gitbook/assets/resource-center.png)
...
![Regional Settings — configuring working days, check-in/checkout times, currency settings, and holidays by country](../../.gitbook/assets/regional-settings.png)
...
![Personal Settings page — language selection, appearance, notification toggles, and username/password update forms](../../.gitbook/assets/profile-settings.png)
...
_MENAREPS — Empowering Pharmaceutical Field Teams_
